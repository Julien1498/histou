...
abstract class Dashboard
{
    ...
    **/
    ...
    @return return null
    **/
    abstract public function addAnnotation($name, $query, $title, $text, $tags, $iconColor = '#751975', $lineColor = '#751975', $datasource = null, $enabled = SHOW_ANNOTATION, $iconSize = 13);
